        ...
        {tab === "products" && (
          <div className="space-y-8">
            ...
            <div className="flex gap-6 text-xs text-white/40 font-bold px-2">
              ...
              <span className="flex items-center gap-2">⠿ Перетащите строку чтобы изменить порядок</span>
            </div>
                ...
                <tbody className="divide-y divide-white/5">
                  {filteredProducts.map(p => (
                    <tr
                      ...
                      className={`transition-all group cursor-grab active:cursor-grabbing ${
                        draggedId === p.id
